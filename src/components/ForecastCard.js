...
const ForecastCard = ({ date, rain, humidity, icon, iconAlt, minTemp, maxTemp, windDirection, windSpeed }) => {
    ...
    return (
            <div className="forecast-day">
                ...
                <div><RiWindyLine /> <RiArrowDownLine style={{ transform: `rotate(${windDirection}deg)` }}/>{windSpeed} mph</div>
            </div>
    );
};
